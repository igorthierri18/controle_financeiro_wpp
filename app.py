...
#############################################################
# FUNÇÕES PARA PROCESSAMENTO DE MENSAGENS                   #
#############################################################
...
def process_expense_message(text, user_id):
    ...
    if expense_data is None or expense_data["amount"] is None:
        return (
            ...
            "• \"Mercado 120,50\"\n\n"
            "Ou tire uma foto do comprovante e envie! 📸"
        )
...
def handle_webhook(request_values):
    ...
    try:
        if num_media > 0:
            # Para a versão simplificada, informa que o recurso será adicionado posteriormente
            resp.message(
                "Recurso de reconhecimento de imagens será adicionado em breve! 🔜\n\n"
                "Por enquanto, você pode registrar suas despesas enviando mensagens de texto, por exemplo:\n"
                "• \"Almoço R$ 35\"\n"
                "• \"Paguei 50 reais de Uber hoje\"\n"
                "• \"Mercado 120,50\""
            )
            ...
            <div class="row hero-card">
                <div class="col-md-6">
                    <div class="hero-content">
                        ...
                        <p>Gerencie suas finanças sem complicação! Envie mensagens descrevendo seus gastos, e nosso sistema cuidará do resto.</p>
                        
                        <div class="feature-item">
                            <i class="bi bi-chat-dots feature-icon"></i>
                            <span class="feature-text">Envie mensagens de texto descrevendo seus gastos</span>
                        </div>
                        ...
                        <div class="feature-item">
                            ...
                            <span class="feature-text">Acesse o dashboard responsivo em qualquer dispositivo</span>
                        </div>
...
if __name__ == '__main__':
    ...
    print(f"\nVersão simplificada do app - as funcionalidades avançadas serão adicionadas posteriormente.")
